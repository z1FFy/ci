...
<p>По вопросом рекламы пишите здесь либо на почту pr@portfolionline.ru </p>
<br>
<form  action="<?php echo $this->config->site_url() ?>id/banner" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<input class="styler" type="text" name="support_mail" maxlength="40" placeholder="Введите свою почту" />
<br><br>
<textarea class="styler" name="support_message" placeholder=""></textarea>
 <br>
