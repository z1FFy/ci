...
<script type="text/javascript">
  $(document).ready(function() {
	...
	var animationTimer = setInterval(move, 6000);
});
</script>
<body>
<!-- <div id="bg_h"> -->
		...
		<div id="c_auth">
			...
			<?php if ($logged == TRUE) {
				...
				echo '<div style="float:right; width: 100px; " id="user_exit"  style="padding: 4px 11px;margin-top: 10px;" class="baatn">Выйти</div>
					  <div style=" width: 100px;" id="user_page" link='.$user_id.' style="padding: 4px 11px;margin-top: 10px;" class="baatn">Моя страница</div>';
			}else{
			 echo '
...
делом. Особенно если причины неудачи не понятны, что же можно придумать в этой не легкой ситуации, чтобы исправить
положение текущих дел? Причин и ошибок в этой области может быть очень много, заметим, что одной из самых часто
встречающихся является отсутствие онлайн-портфолио.PortfoliOnline.ru является наилучшей демонстрацией ваших навыков
и примеров с Вашими работами. Без нашего сервиса PortfoliOnline.ru вы не сможете показать потенциальному заказчику,
теперь Вам не придется ломать голову над вопросам как? Где? И кому? Показать свои работы. PortfoliOnline.ru - это то, с чего
...
<a style="color:#fff;margin-left:110px;font-size:15px;" href="/id/info">Подробнее</a>
	...
	<div id="m_footer">Copyright 2013  portfolionline.ru. All rights reserved. 
	</div>
